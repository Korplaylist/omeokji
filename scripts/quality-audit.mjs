...
assert((guidesDirectory.match(/class="guide-card"/g) || []).length === 7, '활용백서 전용 페이지의 글 수가 맞지 않습니다.');
...
assert(homeLargeImages.length === 5, `홈 활용백서 압축 이미지가 5개여야 합니다: ${homeLargeImages.length}`);
