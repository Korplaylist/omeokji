...
const publishedMenus = [
  ...
  { id: 'rice-ball', title: '바삭 누룽지 주먹밥', copy: '남은 밥을 둥글게 뭉쳐 겉은 바삭하게 구웠어요.', image: '/images/leftover-rice/05-rice-ball-finish-640.webp', url: '/recipes/leftover-rice-recipes#rice-ball', tags: ['밥','남은','간단','15분','혼밥','한식','바삭','고소'] },
  { id: 'kimchi-rice-jeon', title: '참치 김치 밥전', copy: '김치와 참치를 섞어 남은 밥을 든든한 전으로 만들어요.', image: '/images/leftover-rice/10-rice-jeon-finish-640.webp', url: '/recipes/leftover-rice-recipes#kimchi-rice-jeon', tags: ['밥','김치','참치','매콤','간단','15분','한식','남은'] },
  { id: 'egg-rice-porridge', title: '부드러운 계란 밥죽', copy: '딱딱한 냉장밥을 속 편한 계란죽으로 끓여요.', image: '/images/leftover-rice/15-porridge-finish-640.webp', url: '/recipes/leftover-rice-recipes#egg-rice-porridge', tags: ['밥','달걀','순한','부드러운','간단','12분','혼밥','한식','남은'] },
  { id: 'leftover-spicy-tofu-bowl', title: '매콤 두부덮밥', copy: '남은 두부를 고추장 간장 소스에 졸여 밥 위에 올려요.', image: '/images/leftover-tofu/04-spicy-tofu-finish-640.webp', url: '/recipes/leftover-tofu-recipes#spicy-tofu-bowl', tags: ['두부','밥','매콤','짭짤','간단','12분','혼밥','한식','남은'] },
  { id: 'tofu-vegetable-patties', title: '두부채소전', copy: '으깬 두부와 채소를 둥글게 빚어 고소하게 구워요.', image: '/images/leftover-tofu/08-patty-finish-640.webp', url: '/recipes/leftover-tofu-recipes#tofu-vegetable-patties', tags: ['두부','전','고소','부드러운','간단','15분','반찬','한식','남은'] },
  { id: 'potato-cheese-pancakes', title: '감자치즈전', copy: '남은 삶은 감자에 치즈를 섞어 바삭하게 구워요.', image: '/images/leftover-potato/04-cheese-finish-640.webp', url: '/recipes/leftover-potato-recipes#potato-cheese-pancakes', tags: ['감자','치즈','전','고소','간단','15분','간식','한식','남은'] },
  { id: 'potato-salad-sandwich', title: '감자샐러드 샌드위치', copy: '으깬 감자와 채소를 섞어 든든한 샌드위치로 만들어요.', image: '/images/leftover-potato/08-sandwich-finish-640.webp', url: '/recipes/leftover-potato-recipes#potato-salad-sandwich', tags: ['감자','식빵','샌드위치','부드러운','간단','12분','혼밥','남은'] },
  { id: 'spicy-dumpling-bowl', title: '매콤 만두덮밥', copy: '남은 군만두를 김치 양파와 매콤하게 볶아 밥 위에 올려요.', image: '/images/leftover-dumplings/04-spicy-dumpling-finish-640.webp', url: '/recipes/leftover-dumplings-recipes#spicy-dumpling-bowl', tags: ['만두','밥','김치','매콤','짭짤','간단','12분','혼밥','한식','남은'] },
  { id: 'dumpling-egg-jeon', title: '만두계란전', copy: '반으로 자른 군만두를 쪽파 달걀물에 고정해 노릇하게 구워요.', image: '/images/leftover-dumplings/08-egg-finish-640.webp', url: '/recipes/leftover-dumplings-recipes#dumpling-egg-jeon', tags: ['만두','달걀','전','고소','간단','10분','반찬','한식','남은'] },
  { id: 'sausage-vegetable-bowl', title: '소시지야채덮밥', copy: '남은 비엔나소시지를 채소와 케첩 간장 소스로 볶아 밥 위에 올려요.', image: '/images/leftover-sausage/04-bowl-finish-640.webp', url: '/recipes/leftover-sausage-recipes#sausage-vegetable-bowl', tags: ['소시지','밥','채소','짭짤','간단','12분','혼밥','한식','남은'] },
  { id: 'sausage-potato-jeon', title: '소시지감자전', copy: '감자채와 얇게 썬 소시지를 섞어 바삭하게 구워요.', image: '/images/leftover-sausage/08-jeon-finish-640.webp', url: '/recipes/leftover-sausage-recipes#sausage-potato-jeon', tags: ['소시지','감자','전','고소','간단','15분','반찬','한식','남은'] },
  { id: 'spicy-fishcake-bowl', title: '매콤 어묵덮밥', copy: '남은 사각어묵을 고추장 간장 양념에 볶아 밥 위에 올려요.', image: '/images/leftover-fishcake/04-bowl-finish-640.webp', url: '/recipes/leftover-fishcake-recipes#spicy-fishcake-bowl', tags: ['어묵','밥','매콤','짭짤','간단','10분','혼밥','한식','남은'] },
  { id: 'fishcake-egg-jeon', title: '어묵계란전', copy: '사각어묵을 쪽파 당근 달걀물에 고정해 부드럽게 구워요.', image: '/images/leftover-fishcake/08-jeon-finish-640.webp', url: '/recipes/leftover-fishcake-recipes#fishcake-egg-jeon', tags: ['어묵','달걀','전','고소','간단','12분','반찬','한식','남은'] },
  { id: 'miyeok-oi-naengguk', title: '미역오이냉국', copy: '오이와 미역을 차갑고 새콤한 국물로 10분 만에 맞춰요.', image: '/images/miyeok-oi-naengguk/04-finish-640.webp', url: '/recipes/seaweed-cucumber-cold-soup', tags: ['오이','미역','차가운','산뜻','간단','10분','여름','한식','반찬'] },
  { id: 'chicken-breast-soy-rice', title: '15분 간장 닭가슴살덮밥', copy: '닭가슴살을 양파와 간장 소스에 촉촉하게 졸여 밥 위에 올려요.', image: '/images/chicken-breast-soy-rice/04-finish-640.webp', url: '/recipes/soy-chicken-breast-rice-bowl', tags: ["밥","닭가슴살","고기","짭짤","든든","간단","15분","혼밥","한식"] },
  { id: 'gochujang-tuna-bibimbap', title: '10분 고추장 참치비빔밥', copy: '참치캔과 오이, 상추를 고추장 양념장에 비비는 빠른 한 그릇이에요.', image: '/images/gochujang-tuna-bibimbap/04-finish-640.webp', url: '/recipes/gochujang-tuna-bibimbap', tags: ["밥","참치","매콤","새콤","간단","10분","혼밥","한식"] },
  { id: 'cucumber-tofu-cold-salad', title: '12분 오이 두부냉채', copy: '차가운 두부에 오이채와 겨자간장 소스를 올려 산뜻하게 먹어요.', image: '/images/cucumber-tofu-cold-salad/04-finish-640.webp', url: '/recipes/cucumber-tofu-cold-salad', tags: ["두부","오이","채소","차가운","산뜻","간단","12분","반찬","한식","건강"] },
  { id: 'perilla-mushroom-somen', title: '15분 들기름 버섯소면', copy: '소면에 들기름 간장을 비비고 따뜻한 버섯볶음을 올려요.', image: '/images/perilla-mushroom-somen/04-finish-640.webp', url: '/recipes/perilla-mushroom-somen', tags: ["면","버섯","고소","짭짤","간단","15분","혼밥","한식"] },
  { id: 'perilla-tuna-pancake', title: '15분 깻잎 참치전', copy: '깻잎에 참치 속을 얇게 채워 달걀물에 노릇하게 부쳐요.', image: '/images/perilla-tuna-pancake/04-finish-640.webp', url: '/recipes/perilla-leaf-tuna-pancake', tags: ["깻잎","참치","전","고소","짭짤","간단","15분","반찬","한식"] },
  { id: 'potato-egg-soup', title: '15분 감자 계란국', copy: '감자를 얇게 익히고 달걀물을 부드럽게 풀어 맑은 국으로 끓여요.', image: '/images/potato-egg-soup/04-finish-640.webp', url: '/recipes/potato-egg-soup', tags: ['국물','감자','달걀','순한','따뜻','간단','15분','한식','아침'] },
  { id: 'kimchi-bean-sprout-soup', title: '15분 김치콩나물국', copy: '신김치와 콩나물을 멸치육수에 끓여 얼큰하고 시원하게 먹어요.', image: '/images/kimchi-bean-sprout-soup/04-finish-640.webp', url: '/recipes/kimchi-bean-sprout-soup', tags: ["국물","김치","콩나물","매콤","얼큰","간단","15분","한식","따뜻"] },
  { id: 'spam-egg-rice-bowl', title: '10분 스팸 계란덮밥', copy: '스팸과 양파를 간장 소스에 졸이고 달걀을 부드럽게 얹어요.', image: '/images/spam-egg-rice-bowl/04-finish-640.webp', url: '/recipes/spam-egg-rice-bowl', tags: ["밥","스팸","달걀","짭짤","든든","간단","10분","혼밥","한식"] },
  { id: 'soy-fishcake-stir-fry', title: '12분 간장 어묵볶음', copy: '사각어묵과 채소를 간장 양념에 윤기 있게 볶는 밑반찬이에요.', image: '/images/soy-fishcake-stir-fry/04-finish-640.webp', url: '/recipes/soy-fishcake-stir-fry', tags: ["어묵","반찬","짭짤","고소","볶음","간단","12분","한식","도시락"] },
  { id: 'tofu-eggplant-grill', title: '15분 두부 가지구이', copy: '두부와 가지를 노릇하게 굽고 간장 양념장을 올려요.', image: '/images/tofu-eggplant-grill/04-finish-640.webp', url: '/recipes/soy-tofu-eggplant-grill', tags: ["두부","가지","채소","고소","짭짤","간단","15분","반찬","한식"] },
  { id: 'shrimp-egg-fried-rice', title: '12분 새우 계란볶음밥', copy: '새우를 먼저 익히고 달걀을 부드럽게 섞어 고슬고슬하게 볶아요.', image: '/images/shrimp-egg-fried-rice/04-finish-640.webp', url: '/recipes/shrimp-egg-fried-rice', tags: ["밥","새우","달걀","볶음","고소","간단","12분","혼밥","한식"] },
  { id: 'enoki-pancake', title: '15분 팽이버섯전', copy: '팽이버섯을 달걀 반죽에 섞어 한 숟가락씩 바삭하게 부쳐요.', image: '/images/enoki-pancake/04-finish-640.webp', url: '/recipes/enoki-mushroom-pancake', tags: ["버섯","팽이버섯","전","고소","바삭","간단","15분","반찬","한식"] },
  { id: 'tuna-zucchini-jjigae', title: '15분 참치 애호박찌개', copy: '참치캔과 애호박을 고추장 양념에 보글보글 끓여요.', image: '/images/tuna-zucchini-jjigae/04-finish-640.webp', url: '/recipes/tuna-zucchini-jjigae', tags: ["찌개","참치","애호박","매콤","얼큰","간단","15분","한식","따뜻"] },
  { id: 'bok-choy-oyster-stir-fry', title: '10분 청경채 굴소스볶음', copy: '청경채를 마늘기름에 짧게 볶아 굴소스로 윤기 있게 마무리해요.', image: '/images/bok-choy-oyster-stir-fry/04-finish-640.webp', url: '/recipes/bok-choy-oyster-sauce-stir-fry', tags: ['청경채','채소','볶음','짭짤','간단','10분','반찬','한식','혼밥'] },
  { id: 'cucumber-crabstick-cold-salad', title: '10분 오이 맛살냉채', copy: '오이를 짧게 절이고 맛살을 찢어 겨자간장 소스로 산뜻하게 무쳐요.', image: '/images/cucumber-crabstick-cold-salad/04-finish-640.webp', url: '/recipes/cucumber-crabstick-cold-salad', tags: ["오이","맛살","냉채","차가운","새콤","간단","10분","반찬","한식","여름"] },
  { id: 'doenjang-eggplant-stir-fry', title: '12분 가지 된장볶음', copy: '가지를 파마늘기름에 볶고 된장 양념으로 짭짤하고 고소하게 마무리해요.', image: '/images/doenjang-eggplant-stir-fry/04-finish-640.webp', url: '/recipes/soybean-paste-eggplant-stir-fry', tags: ["가지","된장","채소","볶음","짭짤","고소","간단","12분","반찬","한식"] },
  { id: 'potato-tuna-braise', title: '15분 감자 참치조림', copy: '감자를 먼저 익힌 뒤 참치캔을 마지막에 넣어 부서지지 않게 매콤하게 조려요.', image: '/images/potato-tuna-braise/04-finish-640.webp', url: '/recipes/potato-tuna-braise', tags: ["감자","참치","조림","매콤","든든","간단","15분","반찬","한식","혼밥"] },
  { id: 'chive-egg-stir-fry', title: '10분 부추 계란볶음', copy: '계란을 먼저 부드럽게 익히고 부추는 마지막에 넣어 초록색과 향을 살려요.', image: '/images/chive-egg-stir-fry/04-finish-640.webp', url: '/recipes/chive-egg-stir-fry', tags: ["부추","달걀","계란","볶음","고소","간단","10분","반찬","한식","혼밥"] },
  { id: 'tofu-mushroom-hotpot', title: '15분 두부 버섯전골', copy: '두부와 버섯을 냄비에 가지런히 담고 얼큰한 양념육수로 짧게 끓여요.', image: '/images/tofu-mushroom-hotpot/04-finish-640.webp', url: '/recipes/tofu-mushroom-hotpot', tags: ["두부","버섯","국물","얼큰","따뜻","간단","15분","전골","한식","저녁"] },
  { id: 'bean-sprout-rice', title: '15분 간장 콩나물밥', copy: '콩나물 180g을 짧게 데쳐 밥과 간장 양념장에 비벼요.', image: '/images/bean-sprout-rice/04-finish-640.webp', url: '/recipes/soy-bean-sprout-rice', tags: ['밥','콩나물','채소','순한','고소','간단','15분','혼밥','한식'] },
  { id: 'eggplant-rice-bowl', title: '간장 가지덮밥', copy: '제철 가지를 간장양념에 짧게 졸여 밥 위에 바로 올렸어요.', image: '/images/eggplant-rice-bowl/04-finish-640.webp', url: '/recipes/eggplant-rice-bowl', tags: ['밥','가지','채소','짭짤','부드러운','간단','15분','혼밥','한식','여름'] },
  { id: 'zucchini-stir-fry', title: '새우젓 없는 애호박볶음', copy: '제철 애호박을 간장으로 10분 만에 볶아 산뜻한 반찬으로 만들어요.', image: '/images/zucchini-stir-fry/04-finish-640.webp', url: '/recipes/zucchini-stir-fry', tags: ['채소','애호박','반찬','고소','간단','10분','한식','여름'] },
  { id: 'tofu-kongguksu', title: '10분 두부 콩국수', copy: '콩을 불리지 않고 두부와 무가당 두유로 차갑고 고소하게 만들어요.', image: '/images/tofu-kongguksu/04-finish-640.webp', url: '/recipes/quick-tofu-kongguksu', tags: ['면','두부','고소','차가운','간단','10분','혼밥','한식','여름'] },
  { id: 'tomato-egg-stir-fry', title: '10분 토마토 달걀볶음', copy: '토마토와 달걀을 따로 익혀 촉촉하고 부드러운 한 접시로 만들어요.', image: '/images/tomato-egg-stir-fry/04-finish-640.webp', url: '/recipes/tomato-egg-stir-fry', tags: ['달걀','토마토','볶음','부드러운','간단','10분','혼밥','한식','여름'] },
  { id: 'potato-stir-fry', title: '15분 감자채볶음', copy: '감자를 3mm로 썰어 부서지지 않고 아삭하게 볶는 밑반찬이에요.', image: '/images/potato-stir-fry/04-finish-640.webp', url: '/recipes/potato-stir-fry', tags: ['감자','채소','볶음','고소','간단','15분','반찬','한식','혼밥'] },
  { id: 'spicy-cucumber-salad', title: '15분 오이무침', copy: '오이를 10분 절여 물기 없이 새콤매콤하고 아삭하게 무쳐요.', image: '/images/spicy-cucumber-salad/04-finish-640.webp', url: '/recipes/spicy-cucumber-salad', tags: ['오이','채소','무침','매콤','새콤','간단','15분','반찬','한식','여름'] },
  { id: 'seasoned-mung-bean-sprouts', title: '10분 숙주나물무침', copy: '숙주를 2분 데쳐 물기 없이 아삭하고 고소하게 무쳐요.', image: '/images/seasoned-mung-bean-sprouts/04-finish-640.webp', url: '/recipes/seasoned-mung-bean-sprouts', tags: ['숙주','채소','무침','고소','간단','10분','반찬','한식','혼밥'] },
  { id: 'korean-steamed-eggs', title: '12분 뚝배기 계란찜', copy: '달걀물을 체에 걸러 촉촉하고 높게 부푸는 계란찜을 만들어요.', image: '/images/korean-steamed-eggs/04-finish-640.webp', url: '/recipes/korean-steamed-eggs', tags: ['달걀','계란','찜','부드러운','고소','간단','12분','반찬','한식','혼밥'] },
  { id: 'soy-quail-eggs', title: '15분 메추리알 장조림', copy: '간장 비율을 맞춰 짜지 않고 윤기 나는 밑반찬으로 조려요.', image: '/images/soy-quail-eggs/04-finish-640.webp', url: '/recipes/soy-quail-eggs', tags: ['메추리알','반찬','짭짤','간단','15분','한식','혼밥'] },
  { id: 'corn-butter-rice', title: '10분 간장 버터 옥수수밥', copy: '캔옥수수와 찬밥을 고소하고 짭짤한 한 그릇으로 만들어요.', image: '/images/corn-butter-rice/05-finish-640.webp', url: '/recipes/soy-butter-corn-rice', tags: ['밥','옥수수','고소','짭짤','간단','10분','혼밥','한식'] },
  { id: 'enoki-egg-rice', title: '10분 팽이버섯 계란덮밥', copy: '팽이버섯과 달걀을 간장 소스로 촉촉하게 올려요.', image: '/images/enoki-egg-rice/04-finish-640.webp', url: '/recipes/enoki-egg-rice-bowl', tags: ['밥','버섯','달걀','순한','부드러운','간단','10분','혼밥','한식'] },
  { id: 'cabbage-tuna-rice', title: '10분 양배추 참치덮밥', copy: '양배추와 참치를 간장 소스로 촉촉하게 볶아 올려요.', image: '/images/cabbage-tuna-rice/04-finish-640.webp', url: '/recipes/cabbage-tuna-rice-bowl', tags: ['밥','양배추','참치','짭짤','간단','10분','혼밥','한식'] },
  { id: 'king-oyster-mushroom-butter', title: '15분 새송이버섯 간장버터구이', copy: '칼집 낸 새송이버섯을 간장버터 소스로 쫄깃하게 졸여요.', image: '/images/king-oyster-mushroom-butter/04-finish-640.webp', url: '/recipes/soy-butter-king-oyster-mushrooms', tags: ['버섯','새송이버섯','반찬','고소','짭짤','간단','15분','한식','혼밥'] },
  { id: 'tofu-soy-braise', title: '15분 두부조림 황금레시피', copy: '노릇하게 구운 두부를 간장 양념에 짧게 졸여요.', image: '/images/tofu-soy-braise/04-finish-640.webp', url: '/recipes/soy-braised-tofu', tags: ['두부','반찬','짭짤','간단','15분','한식','혼밥','고소'] },
  { id: 'potato-soy-braise', title: '15분 감자조림 황금레시피', copy: '감자를 먼저 익힌 뒤 간장 양념에 윤기 있게 졸여요.', image: '/images/potato-soy-braise/04-finish-640.webp', url: '/recipes/soy-braised-potatoes', tags: ['감자','반찬','짭짤','간단','15분','한식','혼밥','고소'] },
  { id: 'cold-egg-udon', title: '10분 간장 계란 냉우동', copy: '냉동 우동면과 반숙 달걀로 시원하고 짭짤한 한 그릇을 만들어요.', image: '/images/cold-egg-udon/04-finish-640.webp', url: '/recipes/cold-egg-udon', tags: ['면','달걀','차가운','짭짤','간단','10분','혼밥','한식','여름'] },
