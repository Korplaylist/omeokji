...
const publishedMenus = [
  ...
  { id: 'gimbap-jeon', title: '남은 김밥 계란전', copy: '딱딱해진 김밥을 달걀로 촉촉하게 감쌌어요.', image: '/images/leftover-gimbap/03-gimbapjeon-finish-640.webp', url: '/articles/leftover-gimbap.html#gimbap-jeon', tags: ['밥','분식','달걀','고소','순한','간단','10분','혼밥','따뜻','한식','남은'] },
  { id: 'gimbap-fried-rice', title: '파기름 김밥볶음밥', copy: '김밥 속재료까지 잘게 풀어 볶은 든든한 한 그릇이에요.', image: '/images/leftover-gimbap/06-friedrice-finish-640.webp', url: '/articles/leftover-gimbap.html#gimbap-fried-rice', tags: ['밥','분식','볶음','고소','짭짤','간단','12분','혼밥','따뜻','한식','남은'] },
  { id: 'gimbap-hotpot', title: '매콤 김밥전골', copy: '배추 국물에 김밥을 짧게 데워 따뜻하게 즐겨요.', image: '/images/leftover-gimbap/09-hotpot-finish-640.webp', url: '/articles/leftover-gimbap.html#gimbap-hotpot', tags: ['밥','분식','국물','매콤','따뜻','든든','15분','한식','남은'] },
  { id: 'bread-french-toast', title: '촉촉한 프렌치토스트', copy: '마른 식빵이 달걀우유를 만나 부드럽게 살아나요.', image: '/images/leftover-bread/03-french-finish-640.webp', url: '/articles/leftover-bread.html#bread-french-toast', tags: ['빵','달걀','고소','달콤','부드러운','간단','12분','간식','남은'] },
  { id: 'garlic-rusk', title: '바삭 마늘빵 러스크', copy: '남은 식빵 두 장을 바삭한 마늘 간식으로 바꿔요.', image: '/images/leftover-bread/06-rusk-finish-640.webp', url: '/articles/leftover-bread.html#garlic-rusk', tags: ['빵','간식','고소','바삭','간단','20분','남은'] },
  ...
  grid.innerHTML = publishedMenus.map((menu, index) => {
    ...
    return `<li class="recipe-card" data-title="${menu.title}" data-tags="${filterTags}">
      <a href="${menu.url}" aria-label="${menu.title} 레시피 보기">
        <div class="recipe-image"><picture><source media="(min-width:681px)" srcset="${compactImage} 1x, ${smallImage} 1.5x" width="220" height="147" /><img src="${smallImage}" width="320" height="214" loading="lazy" decoding="async" alt="${menu.title} 완성 모습" /></picture>${badge}</div>
